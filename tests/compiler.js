(function() {
    ...
    describe('compiler', function() {
        ...
        it('should fail silently on missing embed templates if requested', function(done) {
            equal('hello world {% embed "missing.njk" ignore missing %}{% endembed %}',
                  'hello world ');
       ...
       // TODO: compile block-set wrapping an embedded block
